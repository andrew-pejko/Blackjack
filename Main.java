...
class Main {
  ...
  public static Integer game(int balance) throws IOException {
    ...
    do{
      System.out.println("How much would you like to bet(in whole dollars)?");
    ...
    card = (int)Math.floor(Math.random() * 13);
  ...
  public static void main(String[] args) throws IOException {
    ...
    // If the user has run out of money again and has no bailouts left the game ends
      ...
      System.out.println("You finished the game with a total of $" + money);
    }
}